...
UINT __stdcall Customer(PVOID lp) {
...
INT main(INT argc, PCHAR argv[]) {
	...
	for (int i = 0; i < TOTAL_CUSTOMER; ++i)ResumeThread(Customer_Handles[i]);
	...
	for (int i = 0; i < MAX_SUSHI; ++i)printf("Sushi %2d ate by %d customer\n", i, Sushi_Counter[i]);
